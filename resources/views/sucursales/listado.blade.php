...
@section('titulo', 'mostrar sucursales')
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Longitud</th>
                                <th scope="col" class="px-4 py-3">Latitud</th>
                            ...
                            @if (isset($sucursales) && $sucursales->count() > 0)
                                @foreach ($sucursales as $sucursal)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            @if ($sucursal->imagen)
                                                <img src="{{ asset($sucursal->imagen) }}"
                                                    class="w-16 h-16 object-cover rounded" alt="Imagen sucursal">
                                            @else
                                                <span class="text-gray-400">Sin imagen</span>
                                            @endif
                                        </td>
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="sucursal-{{ $sucursal->id }}-dropdown-button"
                                                data-dropdown-toggle="sucursal-{{ $sucursal->id }}-dropdown"
                                            ...
                                            <div id="sucursal-{{ $sucursal->id }}-dropdown"
                                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm"
                                                    aria-labelledby="sucursal-{{ $sucursal->id }}-dropdown-button">
                                                    <li>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Agregar sucursal</h3>
                    <button type="button"
