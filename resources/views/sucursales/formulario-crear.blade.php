...
@section('contenido')
    ...
    <section class="bg-white dark:bg-gray-900 mt-10">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Registrar sucursal</h2>
            <form action="/sucursales/store" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="imagen"
                                ...
                                <input id="imagen" name="imagen" type="file" class="hidden" accept="image/jpeg, image/jpg, image/png"/>
                            </label>
                        </div>
