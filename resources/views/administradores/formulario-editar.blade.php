...
@section('contenido')
    ...
    <section class="bg-white dark:bg-gray-900 mt-10">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="/admins/{{ $administradores->id }}/actualizar" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="nombre" id="nombre" required value="{{ $administradores->nombre }}"
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="apellidos" id="apellidos" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Apellido(s)" required value="{{ $administradores->apellidos }}">
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <input type="email" name="correo" id="correo" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="ejemplo@ejemplo.com" required value="{{ $administradores->correo }}">
                    </div>
                    <div class="w-full">
                        <label for="brand"
