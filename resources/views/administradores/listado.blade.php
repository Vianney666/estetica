...
@section('titulo', 'mostrar administradores')
                                ...
                                @foreach ($admins as $admin)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            @if ($admin->imagen)
                                                <img src="{{ asset('storage/' . $admin->imagen) }}"
                                                    class="w-16 h-16 object-cover rounded" alt="Imagen administrador">
                                            @else
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="admin-{{ $admin->id }}-dropdown-button"
                                                data-dropdown-toggle="admin-{{ $admin->id }}-dropdown"
                                            ...
                                            <div id="admin-{{ $admin->id }}-dropdown"
                                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm"
                                                    aria-labelledby="admin-{{ $admin->id }}-dropdown-button">
                                                    <li>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Agregar administrador</h3>
                    <button type="button"
