                                ...
                                @foreach ($clientes as $cliente)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            @if ($cliente->imagen)
                                                <img src="{{ asset('storage/' . $cliente->imagen) }}"
                                                    class="w-16 h-16 object-cover rounded" alt="Imagen cliente">
                                            @else
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            <button id="cliente-{{ $cliente->id }}-dropdown-button"
                                                data-dropdown-toggle="cliente-{{ $cliente->id }}-dropdown"
                                            ...
                                            <div id="cliente-{{ $cliente->id }}-dropdown"
                                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm"
                                                    aria-labelledby="cliente-{{ $cliente->id }}-dropdown-button">
                                                    <li>
