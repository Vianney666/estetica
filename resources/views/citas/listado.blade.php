             ...
             <table class=" min-w-full rounded-xl">
                 <thead>
                     <tr class="bg-gray-50">
                         ...
                         <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Fecha </th>
                         <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Hora </th>
                         <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Cliente ID </th>
                         <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Sucursal ID </th>
                         <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Servicio ID </th>
                     </tr>
                 </thead>
                 <tbody>
